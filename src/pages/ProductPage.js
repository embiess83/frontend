...
const TABLE_HEAD = [
  ...
  { id: 'status', label: 'Situação', alignRight: false },
  { id: '' },
];
    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} component={Link} to="/product/register">
            Registrar Produto
          </Button>
        </Stack>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, description, status, category } = row;
